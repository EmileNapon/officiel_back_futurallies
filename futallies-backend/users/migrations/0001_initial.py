    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('apprenant', 'Apprenant'), ('employeur', 'Employeur'), ('formateur', 'Formateur')], default='apprenant', max_length=10)),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('is_superuser', models.BooleanField(default=False)),
                ('fonction', models.TextField(blank=True, max_length=200, null=True)),
