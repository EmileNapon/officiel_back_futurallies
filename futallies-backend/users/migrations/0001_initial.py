# Generated by Django 4.2.19 on 2025-03-07 12:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'admin'), ('apprenant', 'apprenant'), ('employeur', 'employeur'), ('formateur', 'formateur')], max_length=10)),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('is_superuser', models.BooleanField(default=False)),
                ('fonction', models.TextField(max_length=200, null=True)),
